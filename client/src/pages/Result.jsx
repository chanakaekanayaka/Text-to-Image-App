      ...
      viewport={{once:true}}>
        <div>
          <div className='relative'>
            ...
            <span className={`absolute bottom-0 left-0 h-2 bg-blue-500 ${loading ? 'w-full transition-all duration-[10s]' :'w-0'}`}></span>
        ...
        <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'> 
          ...
          <input 
            ...
            type='text' placeholder='Describe what you want to generate' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20'></input>
