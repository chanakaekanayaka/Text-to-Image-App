  ...
  return (
    <div>
         ...
         <footer className="w-full   text-gray-800">
            ...
            <div className="border-t border-slate-200 flex  items-center">
                <div className="max-w-7xl mx-auto px-6 py-6 text-center text-sm font-normal">
                    <a href="https://NextGenCV.com">NextGenCV</a> ©2025. All rights reserved.
                </div>
                
                <div className="flex items-center gap-5 mt-1 px-4 ">
