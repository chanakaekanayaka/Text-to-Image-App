         ...
         <footer className="w-full   text-gray-800">
            <div className="max-w-7xl mx-auto px-6 py-16 flex flex-col items-center">
                <div className="flex items-center space-x-3 mb-6 hover:scale-105  duration-300 ">
                    <img alt="" className="h-20 justify-center items-center flex pl-[60px]"
                        src="logo.svg" />
                </div>
                <p className="text-center max-w-xl text-sm font-normal leading-relaxed hover:text-blue-600">
            ...
            <div className="border-t border-slate-200 flex  items-center">
                <div className="max-w-7xl mx-auto px-6 py-6 text-center text-sm font-normal">
                    <a href="https://NextGenCV.com" className='hover:text-blue-600 pl-[150px]'>NextGenCV </a> ©2025. All rights reserved.
                </div>
